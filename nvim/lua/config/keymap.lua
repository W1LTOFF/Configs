...
k.set("n", "<C-h>", ":wincmd h<CR>", { silent = true, desc = "Switch to left window" })
k.set("n", "<C-j>", ":wincmd j<CR>", { silent = true, desc = "Switch to down window" })
k.set("n", "<C-k>", ":wincmd k<CR>", { silent = true, desc = "Switch to up window" })
k.set("n", "<C-l>", ":wincmd l<CR>", { silent = true, desc = "Switch to right window" })
...
map({ "n", "i" }, "cc", function() Snacks.bufdelete() end, { desc = "Close current buffer" })
