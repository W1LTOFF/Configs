...
set("n", "ca", vim.lsp.buf.code_action, { silent = true, desc = "Show available code actions" })
...
-- move lines
set({ "n", "v" }, "<A-k>", ":m -2<cr>", { silent = true, desc = "move line up" })
set({ "n", "v" }, "<A-up>", ":m -2<cr>", { silent = true, desc = "move line up" })
set({ "n", "v" }, "<A-j>", ":m +1<cr>", { silent = true, desc = "move line down" })
set({ "n", "v" }, "<A-down>", ":m +1<cr>", { silent = true, desc = "move line down" })
...
set("n", "<Leader>r", ":Telescope lsp_document_symbols<CR>",
	{ silent = true, desc = "Show all document symbols TELESCOPE" })
...
-- Neogit
set("n", "<Leader>g", ":Neogit<CR>", { silent = true, desc = "Show git control" })
